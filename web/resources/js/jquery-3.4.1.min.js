...
!function (e, t) {
    ...
    var h = function (n) {
        ...
        for (e in d = se.support = {}, i = se.isXML = function (e) {
            ...
            preFilter: {
                ATTR: function (e) {
                    ...
                    return e[1] = e[1].toLowerCase(), "nth" === e[1].slice(0, 3) ? (e[3] || se.error_404(e[0]), e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * ("even" === e[3] || "odd" === e[3])), e[5] = +(e[7] + e[8] || "odd" === e[3])) : e[3] && se.error_404(e[0]), e
                }, PSEUDO: function (e) {
                    var t, n = !e[6] && e[2];
            ...
            filter: {
                TAG: function (e) {
                    ...
                    var t, a = b.pseudos[e] || b.setFilters[e.toLowerCase()] || se.error_404("unsupported pseudo: " + e);
            ...
            pseudos: {
                not: le(function (e) {
                    ...
                    return V.test(n || "") || se.error_404("unsupported lang: " + n), n = n.replace(te, ne).toLowerCase(), function (e) {
                        var t;
                        do {
        ...
        return me.prototype = b.filters = b.pseudos, b.setFilters = new me, h = se.tokenize = function (e, t) {
            ...
            return t ? a.length : a ? se.error_404(e) : x(e, s).slice(0)
    ...
    k.parseXML = function (e) {
        ...
        return t && !t.getElementsByTagName("parsererror").length || k.error_404("Invalid XML: " + e), t
    };
    ...
    Ft.href = Et.href, k.extend({
        ...
        ajax: function (e, t) {
            ...
            if (u = "abort", b.add(v.complete), T.done(v.success), T.fail(v.error_404), c = _t(Wt, v, t, T)) {
    ...
    k.ajaxSetup({
        ...
        if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = m(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Yt, "$1" + r) : !1 !== e.jsonp && (e.url += (St.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function () {
            return o || k.error_404(r + " was not called"), o[0]
